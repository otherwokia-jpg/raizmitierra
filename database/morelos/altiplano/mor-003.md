---
id: "MX-MOR-003"
name: "Tianguis de Cuernavaca — La Ciudad de la Eterna Primavera"
region: "altiplano"
state: "morelos"
days: ["Domingo","Sábado","Miércoles"]
coords: [18.9214, -99.2308]
categories: ["canasta-basica","flores-plantas","garnachas-sabor","identidad-oficios"]
safety: "Seguro"
horario: "7:00-16:00"
img: "https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=800"
---

# 🛒 Tianguis de Cuernavaca — La Ciudad de la Eterna Primavera

> La eterna primavera en los tianguis. Fruta de temporada, flores tropicales, plantas de ornato y la cocina morelense.

## 📋 Información Rápida

| Dato | Detalle |
|------|---------|
| 📅 **Día** | Domingo, Sábado, Miércoles |
| ⏰ **Horario** | 7:00-16:00 |
| 📍 **Ubicación** | altiplano, MORELOS |
| 👥 **Ambiente** | Seguro |
| 🛍️ **Categorías** | canasta-basica, flores-plantas, garnachas-sabor, identidad-oficios |
...
- **🔗 Evidencia:** [YouTube](https://www.youtube.com/results?search_query=tianguis+Tianguis+de+Cuernavaca+—+La+Ciudad+de+la+Eterna+Primavera)
...
- **🔗 Evidencia:** [Facebook](https://www.facebook.com/search/pages?q=tianguis+Tianguis+de+Cuernavaca+—+La+Ciudad+de+la+Eterna+Primavera)
...
- **🔗 Evidencia:** [TikTok](https://www.tiktok.com/search?q=tianguis+Tianguis+de+Cuernavaca+—+La+Ciudad+de+la+Eterna+Primavera)
...
- **🔗 Evidencia:** [YouTube](https://www.youtube.com/results?search_query=como+llegar+tianguis+Tianguis+de+Cuernavaca+—+La+Ciudad+de+la+Eterna+Primavera)
...
- **🔗 Evidencia:** [Facebook](https://www.facebook.com/search/pages?q=tianguis+seguro+Tianguis+de+Cuernavaca+—+La+Ciudad+de+la+Eterna+Primavera)
