---
id: "MX-CDMX-002"
name: "Tianguis de Tepito — Barrio Bravo"
region: "centro"
state: "cdmx"
days: ["Martes","Sábado","Domingo"]
coords: [19.445, -99.118]
categories: ["la-paca","chacharas-antiguedades","garnachas-sabor","canasta-basica"]
safety: "Mucha gente, cuidar pertenencias"
horario: "7:00-18:00"
img: "https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=800"
---

# 🛒 Tianguis de Tepito — Barrio Bravo

> El tianguis más famoso de Latinoamérica. Aquí encuentras de todo: ropa de marca, electrónica, chácharas y la mejor comida de barrio.

## 📋 Información Rápida

| Dato | Detalle |
|------|---------|
| 📅 **Día** | Martes, Sábado, Domingo |
| ⏰ **Horario** | 7:00-18:00 |
| 📍 **Ubicación** | centro, CDMX |
| 👥 **Ambiente** | Mucha gente, cuidar pertenencias |
| 🛍️ **Categorías** | la-paca, chacharas-antiguedades, garnachas-sabor, canasta-basica |
...
- **🔗 Evidencia:** [YouTube](https://www.youtube.com/results?search_query=tianguis+Tianguis+de+Tepito+—+Barrio+Bravo)
...
- **🔗 Evidencia:** [Facebook](https://www.facebook.com/search/pages?q=tianguis+Tianguis+de+Tepito+—+Barrio+Bravo)
...
- **🔗 Evidencia:** [TikTok](https://www.tiktok.com/search?q=tianguis+Tianguis+de+Tepito+—+Barrio+Bravo)
...
- **🔗 Evidencia:** [YouTube](https://www.youtube.com/results?search_query=como+llegar+tianguis+Tianguis+de+Tepito+—+Barrio+Bravo)
...
- **🔗 Evidencia:** [Facebook](https://www.facebook.com/search/pages?q=tianguis+seguro+Tianguis+de+Tepito+—+Barrio+Bravo)
