---
id: "MX-PUE-006"
name: "Mercado de Cholula — Los Portales Milenarios"
region: "valle_serdan"
state: "puebla"
days: ["Jueves","Domingo"]
coords: [19.0633, -98.3036]
categories: ["identidad-oficios","garnachas-sabor","canasta-basica"]
safety: "Muy seguro, zona turística"
horario: "8:00-17:00"
img: "https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=800"
---

# 🛒 Mercado de Cholula — Los Portales Milenarios

> El mercado bajo los portales de Cholula. Talavera, cemitas, chiles en nogada y la energía de la ciudad sagrada.
...
| 📅 **Día** | Jueves, Domingo |
| ⏰ **Horario** | 8:00-17:00 |
| 📍 **Ubicación** | valle_serdan, PUEBLA |
| 👥 **Ambiente** | Muy seguro, zona turística |
| 🛍️ **Categorías** | identidad-oficios, garnachas-sabor, canasta-basica |
...
- **🔗 Evidencia:** [YouTube](https://www.youtube.com/results?search_query=tianguis+Mercado+de+Cholula+—+Los+Portales+Milenarios)
...
- **🔗 Evidencia:** [Facebook](https://www.facebook.com/search/pages?q=tianguis+Mercado+de+Cholula+—+Los+Portales+Milenarios)
...
- **🔗 Evidencia:** [TikTok](https://www.tiktok.com/search?q=tianguis+Mercado+de+Cholula+—+Los+Portales+Milenarios)
...
- **🔗 Evidencia:** [YouTube](https://www.youtube.com/results?search_query=como+llegar+tianguis+Mercado+de+Cholula+—+Los+Portales+Milenarios)
...
- **🔗 Evidencia:** [Facebook](https://www.facebook.com/search/pages?q=tianguis+seguro+Mercado+de+Cholula+—+Los+Portales+Milenarios)
